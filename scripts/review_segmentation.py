...
class Segmentation:
        ...
        with open(file_path, encoding='utf8') as fd:
            for line in fd:
                ...
                for segment in segments:
                    ...
                    token_list, pos_tuple = self.pre_process_and_validation_check(segment)
                    if token_list:
    ...
    def pre_process_and_validation_check(segment):
        ...
        first_token_list = ["because", "and", "before", "but", "however", "now", "of", "then", "&", "or", "that",
                            "although"]
        first_person_and_pronoun_words = ["i", "me", "my", "myself", "mine", "we", "us", "our", "ourselves", "he", "she", "him", "her", "am", "they", "them", "themselves", "their",
                                          "theirs",
                                          "you", "yours", "your"]
